...
# and http://gnuwin32.sourceforge.net/packages/gsl.htm
#
# Based on a script of Felix Woelk and Jan Woetzel
# (www.mip.informatik.uni-kiel.de)
#
# It defines the following variables: GSL_FOUND - system has GSL lib
# GSL_INCLUDE_DIRS - where to find headers GSL_LIBRARIES - full path to the
# libraries GSL_LIBRARY_DIRS, the directory where the PLplot library is found.

# CMAKE_GSL_CXX_FLAGS  = Unix compiler flags for GSL, essentially "`gsl-config
# --cxxflags`" GSL_LINK_DIRECTORIES = link directories, useful for rpath on Unix
...
if(WIN32
   ...
   AND NOT MSYS)
  # look for headers
  find_path(GSL_INCLUDE_DIR NAMES gsl/gsl_cdf.h gsl/gsl_randist.h)
  if(GSL_INCLUDE_DIR)

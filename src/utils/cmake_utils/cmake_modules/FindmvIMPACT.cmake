macro(mvIMPACT_REPORT_NOT_FOUND REASON_MSG)
  ...
  # Make results of search visible in the CMake GUI if mvimpact has not been
...
list(APPEND mvIMPACT_CHECK_INCLUDE_DIRS /opt/mvIMPACT_acquire
...
list(APPEND mvIMPACT_CHECK_LIBRARY_DIRS /opt/mvIMPACT_acquire/lib/${ARCH}
...
find_path(
  ...
  PATHS ${mvIMPACT_INCLUDE_DIR_HINTS} ${mvIMPACT_CHECK_INCLUDE_DIRS}
  NO_DEFAULT_PATH)
if(NOT mvIMPACT_INCLUDE_DIR OR NOT EXISTS ${mvIMPACT_INCLUDE_DIR})
  mvimpact_report_not_found(
    ...
    "path to mvimpact include directory," "e.g. /opt/mvIMPACT_acquire.")
else()
...
find_library(
  ...
  PATHS ${mvIMPACT_LIBRARY_DIR_HINTS} ${mvIMPACT_CHECK_LIBRARY_DIRS}
  NO_DEFAULT_PATH)
...
if(mvIMPACT_LIBRARY_DIR)
  ...
  # TODO: add version support string(REGEX MATCH "" mvIMPACT_WORLD_VERSION
  # ${mvIMPACT_PVBASE}) message(STATUS "mvimpact world version: "
  # ${mvIMPACT_WORLD_VERSION})
endif()
...
if(NOT mvIMPACT_INCLUDE_DIR
   AND NOT EXISTS ${mvIMPACT_INCLUDE_DIR}/mvIMPACT_CPP/mvIMPACT_acquire.h)
  mvimpact_report_not_found(
    "Caller defined mvIMPACT_INCLUDE_DIR: " ${mvIMPACT_INCLUDE_DIR}
...
if(mvIMPACT_FOUND)
  find_package_handle_standard_args(Mvimpact DEFAULT_MSG mvIMPACT_INCLUDE_DIRS
                                    mvIMPACT_LIBRARIES)
endif()

# Only mark internal variables as advanced if we found mvimpact, otherwise leave
# it visible in the standard GUI for the user to set manually.
if(mvIMPACT_FOUND)

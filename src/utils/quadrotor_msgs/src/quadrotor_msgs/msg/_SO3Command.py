...
"""
    ...
    def serialize(self, buff):
        ...
        try:
            ...
            self._check_types(
                ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(_x)))
            )
    ...
    def deserialize(self, str):
        ...
        try:
            ...
            (
                ...
                _x.orientation.z,
                _x.orientation.w,
            ) = _struct_7d.unpack(str[start:end])
            start = end
            end += 24
            ...
            (
                _x.aux.enable_motors,
                _x.aux.use_external_yaw,
            ) = _struct_2B.unpack(str[start:end])
    ...
    def deserialize_numpy(self, str, numpy):
        ...
        try:
            ...
            self.aux.angle_corrections = numpy.frombuffer(
                str[start:end], dtype=numpy.float64, count=2
            )
            _x = self
            start = end
            end += 2

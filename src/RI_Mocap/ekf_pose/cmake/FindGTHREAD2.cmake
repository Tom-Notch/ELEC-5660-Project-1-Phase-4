# * Try to find the GTHREAD2 libraries Once done this will define
#
# GTHREAD2_FOUND - system has GTHREAD2 GTHREAD2_INCLUDE_DIR - the GTHREAD2
# include directory GTHREAD2_LIBRARY - GTHREAD2 library

# Copyright (c) 2008 Laurent Montel, <montel@kde.org>
#
# Redistribution aqqqnd use is allowed according to the terms of the BSD
...
if(NOT WIN32)
  ...
  pkgconfig(gthread-2.0 _LibGTHREAD2IncDir _LibGTHREAD2LinkDir
            _LibGTHREAD2LinkFlags _LibGTHREAD2Cflags)
endif(NOT WIN32)

find_path(
  GTHREAD2_MAIN_INCLUDE_DIR glib.h
...
find_path(
  GTHREAD2_INTERNAL_INCLUDE_DIR glibconfig.h
...
if(GTHREAD2_INTERNAL_INCLUDE_DIR)
  set(GTHREAD2_INCLUDE_DIR ${GTHREAD2_INCLUDE_DIR}
                           "${GTHREAD2_INTERNAL_INCLUDE_DIR}")
endif(GTHREAD2_INTERNAL_INCLUDE_DIR)

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(GTHREAD2 DEFAULT_MSG GTHREAD2_LIBRARY
